...
Namespace SimplyCastWrapper
    ...
    Public Class Main
        ...
        Public Shared Function ContactList_Retrieve_Request(ListID As Integer) As ContactList
            ...
            Return connection.API_Call(Of ContactList)(SimplyCastAPI.API_GET, "contactmanager/lists/" + ListID, Nothing, Nothing)
            'Return httpstatuscodes.OK
        End Function
        'Retrieve by name
        ...
        Public Shared Function ContactList_Modify_Request(listID As Integer, newname As String) As ContactList
            Dim List As ContactList = New ContactList
            List.name = newname
            Return connection.API_Call(Of ContactList)(SimplyCastAPI.API_POST, "contactmanager/lists/" + listID, Nothing, List)
            ' Return httpstatuscodes.OK
        End Function
        ...
        Public Shared Sub ContactList_Delete_Request(listID As Integer)
            connection.API_Call(Of Object)(SimplyCastAPI.API_DELETE, "contactmanager/lists/" + listID, Nothing, Nothing)
        ...
        Public Shared Function ContactList_AddToList_Request(listID As Integer, contacts As List(Of Integer), strict As Boolean) As List(Of Contact)
            ...
            Return connection.API_Call(Of List(Of Contact))("POST", "contactmanager/lists/" + listID + "/contacts", queryParams, contacts)
        End Function
        ...
        Public Shared Sub ContactList_DeleteFromList_Request(listID As Integer, contactID As Integer)
            connection.API_Call(Of Object)("DELETE", "contactmanager/lists/" + listID + "/contacts/" + contactID, Nothing, Nothing)
        ...
        End Function
        'Contacts
        Public Shared Function Contacts_GetGeneral_Request(extended As Boolean, ignoreEmptyFields As Boolean, limit As Integer, offset As Integer, query As String) As Contact
            Dim queryparams As Dictionary(Of String, String) = New Dictionary(Of String, String)()
            queryparams.Add("offset", offset.ToString())
            ...
            Return connection.API_Call(Of Contact)("GET", "contactmanager/contacts", queryparams, Nothing)
            ' Return httpstatuscodes.OK
        End Function
        ...
        Public Shared Function Contacts_Create_Request(fields As Dictionary(Of String, String), Optional listIDs As List(Of Integer) = Nothing) As Contact
            ...
            Else
                ...
                For Each f As KeyValuePair(Of String, String) In fields
                    ...
                    Dim fieldEntity As Field = New Field()
        ...
        Public Shared Function Contacts_GetByID_Request(contactID As Integer) As Contact
            Return connection.API_Call(Of Contact)("GET", "contactmanager/contacts/" + contactID, Nothing, Nothing)
            ' Return httpstatuscodes.OK
        End Function
        ...
        Public Shared Sub Contacts_DeleteGeneral_Request(contactID As Integer)
            connection.API_Call(Of Object)("DELETE", "contactmanager/contacts/" + contactID, Nothing, Nothing)
        ...
        Public Shared Function Contacts_CreateWithBatch_Request(mergeColumn As String, requests As List(Of Contact)) As List(Of Contact)
            Dim queryParameters As Dictionary(Of String, String) = New Dictionary(Of String, String)()
        ...
        Public Shared Function Metadata_Column_Modify_Request(columnid As Integer, name As String) As Metadata
            Dim requestBody As Metadata = New Metadata
            requestBody.name = name
        ...
        Public Shared Function Columns_ContactManager_RetrieveAll_Response(columns As List(Of Column), filterCount As Integer, links As List(Of ContactList), responseCount As Integer, totalCount As Integer) As Integer
            ...
            Return httpstatuscodes.OK
        End Function
        Public Shared Function Columns_CreateNew(mergeTags As List(Of String), name As String, Type As String) As Integer
        ...
        Public Shared Function Columns_Mergetags_Request(append As Boolean, columnID As String, mergetags As List(Of String)) As Column
            Dim queryParameters As Dictionary(Of String, String) = New Dictionary(Of String, String)()
        ...
        Public Shared Function SC360_Get360Project_Request(projectID As Integer) As SC360Project
            Return connection.API_Call(Of SC360Project)("GET", "crossmarketer/" + projectID, Nothing, Nothing)
        ...
        Public Shared Sub SC360_PushContactTo360InboundAPIConnElem_Request(projectID As Integer, connectionID As Integer, listID As Integer, contactID As Integer)
            ...
            connection.API_Call(Of Object)("POST", "crossmarketer/" + projectID + "/inbound/" + connectionID, Nothing, mycontact)
        End Sub
