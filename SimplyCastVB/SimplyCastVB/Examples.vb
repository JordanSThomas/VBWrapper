...
Namespace SimplyCastWrapper
    Public Class Examples
        ...
        Public Sub ContactManagementExample()
            ...
            Console.WriteLine("Created test list " + myList.Pub_ID)
            ...
            Console.WriteLine("Created contact " + myContact.pub_ID)

            '' //Attempt an 'upsert operation' on the created contact. The name
            '' //should be updated to the given value.
            Console.WriteLine("Attempting upsert (should update contact " + myContact.pub_ID + ").")

            fields.Item(Main.Columns_ContactManager_RetrieveByName_Request("name", columns).pub_id) = "Updated Test Contact"
            Dim contacts As List(Of Contact) = Main.Contacts_UpdateMultiple_Request(Main.Columns_ContactManager_RetrieveByName_Request("email", columns).pub_id, fields)
            ...
            Dim query As String = "`" + (Main.Columns_ContactManager_RetrieveByName_Request("email", columns).pub_id + "` = ""test@example.com"" AND `" + Main.Columns_ContactManager_RetrieveByName_Request("name", columns).pub_id + "` = ""Updated Test Contact""")
            ...
            Dim email As String = myContact.pub_Fields.Find(Function(x) x.pub_name.Contains("email")).value
            ...
            Dim metadataFieldID As String = metadataColumns.Find(Function(x) x.name.Equals("Tags")).pub_id
            ...
            Console.WriteLine("Contact belongs to " + myContact.pub_lists.Count + " lists")
        ...
        Public Sub ColumnManagementExample()
            ...
            If (Main.Columns_ContactManager_RetrieveByName_Request("test column", myColumns) Is Nothing) Then
                ...
                Console.WriteLine("Created column " + myColumn.pub_id)
        ...
        Public Sub MetadataColumnManagementExample()
            ...
            Console.WriteLine("Created test contact " + mycontact.pub_ID)
            ...
            Dim singleColumn As Metadata =
                Main.Metadata_Column_Modify_Request(mycontact.pub_ID, metadataColumns.Find(Function(x) x.name.Equals("Test Single Column")).pub_id, New List(Of String)({"2"}))
        ...
        Public Sub SimplyCast360Example(contactID As Integer, projectID As Integer, inboundConnectionID As Integer, outboundConnectionID As Integer)
            ...
            Console.WriteLine("Loaded contact " + mycontact.pub_ID)
